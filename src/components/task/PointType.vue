...
<!--    https://cn.vuejs.org/guide/components/events.html-->
    <input type="radio" :name="name" value="path"  :checked="pointType ==='path'" @click="$emit('update:pointType', 'path')"/>
...
<!--    <input type="radio" :name="name" value="target" :checked="pointType==='target'" @click="$emit('pointTypeChange', 'target')"/>-->
    <input type="radio" :name="name" value="target" :checked="pointType==='target'" @click="$emit('update:pointType', 'target')"/>
